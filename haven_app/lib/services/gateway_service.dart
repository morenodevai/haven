...
class GatewayService {
  ...
  // -- HTP convenience commands --

  void htpOfferSend(String targetUserId, int sessionId, String filename,
      int size, int chunkCount, String salt) {
    send({
      'type': 'HtpOfferSend',
      'data': {
        'target_user_id': targetUserId,
  ...
  void htpAcceptSend(String targetUserId, int sessionId) {
    send({
      'type': 'HtpAcceptSend',
      'data': {
        'target_user_id': targetUserId,
  ...
  void htpNackSend(String targetUserId, int sessionId, List<int> missing) {
    send({
      'type': 'HtpNackSend',
      'data': {
        'target_user_id': targetUserId,
  ...
  void htpRttSend(String targetUserId, int sessionId, int rttUs) {
    send({
      'type': 'HtpRttSend',
      'data': {
        'target_user_id': targetUserId,
  ...
  void htpAckSend(String targetUserId, int sessionId, int upTo) {
    send({
      'type': 'HtpAckSend',
      'data': {
        'target_user_id': targetUserId,
  ...
  void htpDoneSend(String targetUserId, int sessionId, int totalBytes) {
    send({
      'type': 'HtpDoneSend',
      'data': {
        'target_user_id': targetUserId,
  ...
  void htpCancelSend(String targetUserId, int sessionId, String reason) {
    send({
      'type': 'HtpCancelSend',
      'data': {
        'target_user_id': targetUserId,
