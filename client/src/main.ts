    ...
    root.innerHTML = `
      <div style="display:flex;align-items:center;justify-content:center;height:100%;background:#1a1a2e;color:#e4e4e7;font-family:system-ui,sans-serif;">
        <div style="text-align:center;max-width:420px;padding:40px;">
          ...
          <button id="haven-retry" style="background:#6c63ff;color:white;border:none;border-radius:8px;padding:12px 24px;font-weight:600;cursor:pointer;font-size:14px;">Retry</button>
        </div>
      </div>`;
